  ...
  return (
    <aside className="fixed left-6 top-24 bottom-6 flex flex-col p-6 bg-[#0b1326]/40 backdrop-blur-[40px] border border-white/5 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] rounded-3xl w-72 z-40 hidden lg:flex">
      ...
      <nav className="flex-1 space-y-2">
        <a className="flex items-center gap-4 bg-white/10 text-white rounded-xl px-5 py-3.5 border border-white/10 transition-all group" href="#">
          <Activity className="w-5 h-5 group-hover:scale-110 transition-transform" />
          <span className="text-sm font-semibold tracking-wide">Overview</span>
        </a>
        <a className="flex items-center gap-4 text-[#ccc3d8] hover:text-white px-5 py-3.5 rounded-xl hover:bg-white/5 transition-all group" href="#">
          <History className="w-5 h-5 group-hover:scale-110 transition-transform" />
          <span className="text-sm font-semibold tracking-wide">Logs</span>
        </a>
        <a className="flex items-center gap-4 text-[#ccc3d8] hover:text-white px-5 py-3.5 rounded-xl hover:bg-white/5 transition-all group" href="#">
      ...
      <div className="mt-auto space-y-4">
        ...
        <button className="w-full py-3 flex items-center gap-3 px-5 text-[#ccc3d8] hover:text-white transition-colors group">
